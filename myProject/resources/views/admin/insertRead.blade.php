    ...
    <div class="modal-content">
      ...
      <select class="form-select mb-2" aria-label="Default select example" id="Category" name="ProductCategory">
       ...
       <option value="kids">Kids</option>
        ...
        <button type="submit" class="btn btn-outline-secondary fw-bold fs-5 ">Add Record</button>
       </form>
...
<table class = "table mt-5">
  ...
  @foreach($data as $item)
    <tr>
      ...
      <td class="pt-5"><input type="hidden" name = "ProductCategory" value="{{$item ['ProductCategory']}}">{{$item ['ProductCategory']}}</td>
